    ...
    <>
      ...
      <Container as="section" className="pb-section">
        <p className="measure text-muted">
          The privacy policy is written in S6, alongside the intake flow that will collect
          the data it describes. This route exists now so the footer link resolves rather
          than 404.
        </p>
      </Container>
    </>
